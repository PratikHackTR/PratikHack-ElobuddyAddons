...
namespace AkaCore.Manager
{
    class MenuManager
    {
        ...
        {
            HMenu = MainMenu.AddMenu("AnaDosya/MainFile", "akacdsore");
            HMenu.AddGroupLabel("Wingame scriptleri için lazım");
            HMenu.AddGroupLabel("Need it for WinGame scripts");
        }
        ...
        {
            FPS = HMenu.AddSubMenu("FPS koruması / FPS Protection", "asd");
